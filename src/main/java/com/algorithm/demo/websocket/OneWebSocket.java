...
public class OneWebSocket {
    ...
    private static Logger log = Logger.getLogger(OneWebSocket.class);
    ...
    public void onOpen(Session session) {
        ...
        log.debug("有新连接加入：{}，当前在线人数为：{}"+session.getId()+onlineCount.get());
    }
    ...
    public void onClose(Session session) {
        ...
        log.debug("有一连接关闭：{}，当前在线人数为：{}"+session.getId()+onlineCount.get());
    }
